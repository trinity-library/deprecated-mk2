...
import sisterhood.hentai.business.HitomiClient
...
class KtorHitomiClient(private val httpClient: HttpClient) : HitomiClient {
    ...
    override suspend fun requestGallery(id: HentaiId): Result<HitomiGallery?> =
    ...
    override suspend fun requestGalleryIds(language: HitomiLanguage, offset: Int, limit: Int): Result<List<HentaiId>> =
    ...
    override suspend fun requestThumbnail(
